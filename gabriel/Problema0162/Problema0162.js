...
let valorIngressos = 50;
let quantidadeVendas = 120;
let lucroFinal = parseInt(valorIngressos * quantidadeVendas - 2000);

console.log("Lucros com o valor do ingresso sendo " + valorIngressos + " e a quantidade de vendas sendo " + quantidadeVendas + ":" + lucroFinal);
console.log(" ");
